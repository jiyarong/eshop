class DropLegacyOzonPerformanceAdTables < ActiveRecord::Migration[8.1]
  def up
    drop_table :raw_ozon_performance_daily_stats
    drop_table :raw_ozon_performance_campaign_skus
    drop_table :raw_ozon_performance_campaigns
  end
  ...
  def down
    ...
    create_table :raw_ozon_performance_daily_stats do |t|
      ...
      t.decimal :orders_revenue, precision: 15, scale: 2, default: 0
      t.datetime :synced_at
      t.timestamps
    end
