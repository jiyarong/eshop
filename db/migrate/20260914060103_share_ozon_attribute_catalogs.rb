class ShareOzonAttributeCatalogs < ActiveRecord::Migration[8.1]
  def up
    ...
    remove_foreign_key :raw_ozon_category_attributes, column: :account_id, if_exists: true
    remove_foreign_key :raw_ozon_attribute_values, column: :account_id, if_exists: true
    remove_index :raw_ozon_category_attributes, name: "idx_raw_ozon_cat_attrs_unique", if_exists: true
    remove_index :raw_ozon_category_attributes, name: "idx_raw_ozon_cat_attrs_category_type", if_exists: true
    remove_index :raw_ozon_category_attributes, name: "idx_raw_ozon_cat_attrs_dictionary", if_exists: true
    remove_index :raw_ozon_category_attributes, name: "idx_raw_ozon_category_attributes_on_account_id", if_exists: true
    remove_index :raw_ozon_attribute_values, name: "idx_raw_ozon_attr_values_unique", if_exists: true
    remove_index :raw_ozon_attribute_values, name: "idx_raw_ozon_attr_values_attribute", if_exists: true
    remove_index :raw_ozon_attribute_values, name: "idx_raw_ozon_attr_values_value", if_exists: true
    remove_index :raw_ozon_attribute_values, name: "idx_raw_ozon_attribute_values_on_account_id", if_exists: true
