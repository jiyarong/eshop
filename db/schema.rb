...
ActiveRecord::Schema[8.1].define(version: 2026_09_23_103530) do
  ...
  create_table "ec_sku_diagnosis_rules", force: :cascade do |t|
    t.jsonb "configuration", default: {"context_keys" => ["base", "inventory", "lifecycle", "profit", "sales_funnel", "advertise_per_week", "ec_orders_full_period", "supply_orders_full_period", "operation_actions_full_period", "warehouse_recommendation", "search_terms_per_week", "ozon_listing_content", "wb_listing_content"]}, null: false
    t.datetime "created_at", null: false
    t.boolean "enabled", default: true, null: false
  ...
  create_table "ec_skus", force: :cascade do |t|
    ...
    t.index ["operation_status"], name: "index_ec_skus_on_operation_status"
  ...
  create_table "raw_ozon_cross_dock_tariff_snapshots", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "currency_code", default: "RUB", null: false
    t.date "effective_from", null: false
    t.date "effective_to"
    ...
    t.string "market_code", default: "ru", null: false
    t.integer "row_count"
    ...
    t.datetime "updated_at", null: false
    t.index ["market_code", "effective_from"], name: "idx_raw_ozon_cross_dock_snapshots_effective"
    t.index ["market_code", "source_checksum"], name: "idx_raw_ozon_cross_dock_snapshots_source", unique: true
    t.index ["market_code"], name: "idx_raw_ozon_cross_dock_snapshots_current", unique: true, where: "is_current"
  end

  create_table "raw_ozon_cross_dock_tariffs", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["snapshot_id", "destination_cluster_key"], name: "idx_raw_ozon_cross_dock_tariffs_destination"
    t.index ["snapshot_id", "supply_receiving_zone_key", "destination_cluster_key"], name: "idx_raw_ozon_cross_dock_tariffs_identity", unique: true
    t.index ["snapshot_id"], name: "index_raw_ozon_cross_dock_tariffs_on_snapshot_id"
  end

  create_table "raw_ozon_default_logistics_tariffs", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.index ["snapshot_id", "volume_band_order"], name: "idx_raw_ozon_default_logistics_tariffs_identity", unique: true
    t.index ["snapshot_id"], name: "index_raw_ozon_default_logistics_tariffs_on_snapshot_id"
  end
  ...
  create_table "raw_ozon_logistics_tariff_snapshots", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "currency_code", default: "RUB", null: false
    ...
    t.string "status", default: "running", null: false
    t.datetime "updated_at", null: false
    t.index ["market_code", "effective_from"], name: "idx_raw_ozon_logistics_snapshots_effective"
    t.index ["market_code", "source_checksum"], name: "idx_raw_ozon_logistics_snapshots_source", unique: true
    t.index ["market_code"], name: "idx_raw_ozon_logistics_snapshots_current", unique: true, where: "is_current"
  end

  create_table "raw_ozon_logistics_tariffs", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "destination_cluster_key", null: false
    t.string "destination_cluster_name", null: false
    t.decimal "fbo_fresh_over_300_rub", precision: 12, scale: 2, null: false
    ...
    t.decimal "volume_max_l", precision: 10, scale: 3
    t.decimal "volume_min_l", precision: 10, scale: 3, null: false
    t.index ["snapshot_id", "origin_cluster_key", "destination_cluster_key", "volume_min_l"], name: "idx_raw_ozon_logistics_tariffs_lookup"
    t.index ["snapshot_id", "volume_band_order", "origin_cluster_key", "destination_cluster_key"], name: "idx_raw_ozon_logistics_tariffs_identity", unique: true
    t.index ["snapshot_id"], name: "index_raw_ozon_logistics_tariffs_on_snapshot_id"
  end
  ...
  create_table "raw_ozon_warehouse_clusters", force: :cascade do |t|
    t.bigint "account_id", null: false
    ...
    t.index ["account_id", "normalized_warehouse_name"], name: "idx_raw_ozon_warehouse_clusters_lookup"
    t.index ["account_id", "warehouse_id"], name: "idx_raw_ozon_warehouse_clusters_unique", unique: true
    t.index ["account_id"], name: "index_raw_ozon_warehouse_clusters_on_account_id"
  end
  ...
  create_table "raw_wb_finance_details", force: :cascade do |t|
    ...
    t.index ["account_id", "wb_report_id"], name: "idx_raw_wb_finance_details_report"
  end
  ...
  create_table "raw_wb_logistics_tariff_snapshots", force: :cascade do |t|
    t.datetime "completed_at"
    t.datetime "created_at", null: false
    ...
    t.string "status", default: "running", null: false
    t.datetime "updated_at", null: false
    t.index ["is_current"], name: "idx_raw_wb_logistics_tariff_snapshots_current", unique: true, where: "is_current"
    t.index ["requested_date", "status"], name: "idx_raw_wb_logistics_tariff_snapshots_requested_status"
    t.index ["source_account_id"], name: "index_raw_wb_logistics_tariff_snapshots_on_source_account_id"
  end

  create_table "raw_wb_logistics_tariffs", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "warehouse_name", null: false
    t.index ["snapshot_id", "delivery_mode", "warehouse_name", "geo_name"], name: "idx_raw_wb_logistics_tariffs_unique", unique: true
    t.index ["snapshot_id", "delivery_mode"], name: "idx_raw_wb_logistics_tariffs_snapshot_mode"
    t.index ["snapshot_id"], name: "index_raw_wb_logistics_tariffs_on_snapshot_id"
  end
  ...
  create_table "raw_wb_sales_funnel_period", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "add_to_cart", default: 0
    t.decimal "add_to_cart_dynamic", precision: 10, scale: 2
    t.bigint "add_to_wishlist", default: 0
    t.decimal "add_to_wishlist_dynamic", precision: 10, scale: 2
    t.decimal "avg_orders_per_day", precision: 10, scale: 4
    t.decimal "avg_orders_per_day_dynamic", precision: 10, scale: 2
    t.decimal "avg_price", precision: 10, scale: 2
    t.decimal "avg_price_dynamic", precision: 10, scale: 2
    t.string "brand"
    t.decimal "buyout_percent", precision: 10, scale: 2
    t.decimal "buyout_percent_dynamic", precision: 10, scale: 2
    t.bigint "buyouts", default: 0
    t.decimal "buyouts_dynamic", precision: 10, scale: 2
    t.decimal "buyouts_sum", precision: 15, scale: 2
    t.decimal "buyouts_sum_dynamic", precision: 10, scale: 2
    t.bigint "cancel_count", default: 0
    t.decimal "cancel_count_dynamic", precision: 10, scale: 2
    t.decimal "cancel_sum", precision: 15, scale: 2
    t.decimal "cancel_sum_dynamic", precision: 10, scale: 2
    t.decimal "cart_to_order", precision: 10, scale: 4
    t.decimal "cart_to_order_dynamic", precision: 10, scale: 2
    t.decimal "conv_to_cart", precision: 10, scale: 4
    t.decimal "conv_to_cart_dynamic", precision: 10, scale: 2
    t.datetime "created_at", null: false
    t.string "currency", default: "RUB", null: false
    t.decimal "feedback_rating", precision: 5, scale: 2
    t.decimal "localization_percent", precision: 10, scale: 2
    t.decimal "localization_percent_dynamic", precision: 10, scale: 2
    t.bigint "nm_id", null: false
    t.bigint "open_card", default: 0
    t.decimal "open_card_dynamic", precision: 10, scale: 2
    t.bigint "orders", default: 0
    t.decimal "orders_dynamic", precision: 10, scale: 2
    t.decimal "orders_sum", precision: 15, scale: 2
    t.decimal "orders_sum_dynamic", precision: 10, scale: 2
    t.bigint "past_add_to_cart", default: 0
    t.bigint "past_add_to_wishlist", default: 0
    t.decimal "past_avg_orders_per_day", precision: 10, scale: 4
    t.decimal "past_avg_price", precision: 10, scale: 2
    t.decimal "past_buyout_percent", precision: 10, scale: 2
    t.bigint "past_buyouts", default: 0
    t.decimal "past_buyouts_sum", precision: 15, scale: 2
    t.bigint "past_cancel_count", default: 0
    t.decimal "past_cancel_sum", precision: 15, scale: 2
    t.decimal "past_cart_to_order", precision: 10, scale: 4
    t.decimal "past_conv_to_cart", precision: 10, scale: 4
    t.decimal "past_localization_percent", precision: 10, scale: 2
    t.bigint "past_open_card", default: 0
    t.bigint "past_orders", default: 0
    t.decimal "past_orders_sum", precision: 15, scale: 2
    t.decimal "past_share_order_percent", precision: 10, scale: 2
    t.integer "past_time_to_ready_days"
    t.integer "past_time_to_ready_hours"
    t.integer "past_time_to_ready_mins"
    t.decimal "past_wb_club_avg_orders_per_day", precision: 10, scale: 4
    t.decimal "past_wb_club_avg_price", precision: 10, scale: 2
    t.decimal "past_wb_club_buyout_percent", precision: 10, scale: 2
    t.bigint "past_wb_club_buyouts", default: 0
    t.decimal "past_wb_club_buyouts_sum", precision: 15, scale: 2
    t.bigint "past_wb_club_cancel_count", default: 0
    t.decimal "past_wb_club_cancel_sum", precision: 15, scale: 2
    t.bigint "past_wb_club_orders", default: 0
    t.decimal "past_wb_club_orders_sum", precision: 15, scale: 2
    t.date "period_end", null: false
    t.date "period_start", null: false
    t.string "product_name"
    t.decimal "product_rating", precision: 5, scale: 2
    t.jsonb "raw_json", default: {}, null: false
    t.decimal "share_order_percent", precision: 10, scale: 2
    t.decimal "share_order_percent_dynamic", precision: 10, scale: 2
    t.decimal "stock_balance_sum", precision: 15, scale: 2
    t.bigint "stock_mp", default: 0
    t.bigint "stock_wb", default: 0
    t.string "subject"
    ...
    t.datetime "updated_at", null: false
    t.string "vendor_code"
    t.decimal "wb_club_avg_orders_per_day", precision: 10, scale: 4
    t.decimal "wb_club_avg_orders_per_day_dynamic", precision: 10, scale: 2
    t.decimal "wb_club_avg_price", precision: 10, scale: 2
    t.decimal "wb_club_avg_price_dynamic", precision: 10, scale: 2
    t.decimal "wb_club_buyout_percent", precision: 10, scale: 2
    t.decimal "wb_club_buyout_percent_dynamic", precision: 10, scale: 2
    t.bigint "wb_club_buyouts", default: 0
    t.decimal "wb_club_buyouts_dynamic", precision: 10, scale: 2
    t.decimal "wb_club_buyouts_sum", precision: 15, scale: 2
    t.decimal "wb_club_buyouts_sum_dynamic", precision: 10, scale: 2
    t.bigint "wb_club_cancel_count", default: 0
    t.decimal "wb_club_cancel_count_dynamic", precision: 10, scale: 2
    t.decimal "wb_club_cancel_sum", precision: 15, scale: 2
    t.decimal "wb_club_cancel_sum_dynamic", precision: 10, scale: 2
    t.bigint "wb_club_orders", default: 0
    t.decimal "wb_club_orders_dynamic", precision: 10, scale: 2
    t.decimal "wb_club_orders_sum", precision: 15, scale: 2
    t.decimal "wb_club_orders_sum_dynamic", precision: 10, scale: 2
    t.index ["account_id", "period_start", "period_end", "nm_id"], name: "idx_raw_wb_sales_funnel_period_unique", unique: true
    t.index ["account_id"], name: "index_raw_wb_sales_funnel_period_on_account_id"
  ...
  add_foreign_key "raw_ozon_cross_dock_tariffs", "raw_ozon_cross_dock_tariff_snapshots", column: "snapshot_id"
  add_foreign_key "raw_ozon_default_logistics_tariffs", "raw_ozon_logistics_tariff_snapshots", column: "snapshot_id"
  ...
  add_foreign_key "raw_ozon_logistics_tariffs", "raw_ozon_logistics_tariff_snapshots", column: "snapshot_id"
  ...
  add_foreign_key "raw_wb_logistics_tariff_snapshots", "raw_wb_seller_accounts", column: "source_account_id"
  add_foreign_key "raw_wb_logistics_tariffs", "raw_wb_logistics_tariff_snapshots", column: "snapshot_id"
