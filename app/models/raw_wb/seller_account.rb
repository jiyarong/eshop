module RawWb
  class SellerAccount < ApplicationRecord
    ...
    has_many :warehouse_name_mappings, class_name: 'RawWb::WarehouseNameMapping',  foreign_key: :account_id, dependent: :destroy
    ...
    has_many :search_report_products,  class_name: 'RawWb::SearchReportProduct',  foreign_key: :account_id, dependent: :destroy
