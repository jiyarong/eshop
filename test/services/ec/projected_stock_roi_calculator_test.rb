...
class Ec::ProjectedStockRoiCalculatorTest < ActiveSupport::TestCase
  test "returns projected holding-cost roi metrics for valid inputs" do
    ...
    assert_in_delta 24.1071, result[:projected_unit_profit_cny].to_f, 0.0001
    assert_in_delta 8678.57, result[:projected_operating_net_profit_cny].to_f, 0.2
  ...
  test "returns blank roi when cost or volume inputs are unusable" do
    ...
    assert_equal BigDecimal("24.107142857142857142857142857143"), missing_cost[:projected_unit_profit_cny]
    assert_equal BigDecimal("8678.57142857142857142857142857148"), missing_cost[:projected_operating_net_profit_cny]
    ...
    assert_equal BigDecimal("24.107142857142857142857142857143"), missing_volume[:projected_unit_profit_cny]
    assert_equal BigDecimal("8678.57142857142857142857142857148"), missing_volume[:projected_operating_net_profit_cny]
  ...
  test "returns blank roi when date range is invalid" do
    ...
    assert_nil invalid_date_range[:projected_unit_profit_cny]
    assert_nil invalid_date_range[:projected_operating_net_profit_cny]
  ...
  test "returns blank roi when net sales are non-positive" do
    ...
    assert_nil non_positive_net_sales[:projected_unit_profit_cny]
    assert_nil non_positive_net_sales[:projected_operating_net_profit_cny]
